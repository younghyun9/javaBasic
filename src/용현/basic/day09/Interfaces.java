...
public class Interfaces {
    public static void main(String[] args) {
        ...
        // 추상화라는 개념을 적절하고 효율적으로 사용할 수 있도록 문법적으로 지원해주는 논리적 도구가 바로 인터페이스 !

        // 추상메서드와 상수만으로 구성된 클래스를 인터페이스라 함
        // 어떤 클래스를 만들때 추상메서드를 통해 기본이 되는 틀을 제공하여 규칙에 맞게 코드를 짤수있게함
        // 클래스와는 달리 다중상속을 지원함

        // 인터페이스 작성시 interface라는 예약어를 사용하고
        // 인터페이스를 구현하려면 implements 키워드를 사용해야함
...
class Cat3 extends Animal3 implements Animal3Action{                         // implements
