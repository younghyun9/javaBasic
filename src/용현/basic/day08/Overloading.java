...
public class Overloading {
    public static void main(String[] args) {
        ...
        // 메서드의 서명을 다르게 해서 한 클래스에서 같은 이름의 메서드를 2개이상 선언하는것

        // 정수/실수 매개변수를 2개 또는 3개를 이용해서 간단한 덧셈을 수행하는 프로그램 작성

        // 매개변수를 어떻게 지정하느냐에 따라 간편하게 식을 바꿀수있다!
        ...
        System.out.println("");
        System.out.println( ' ' );    // 괄호안에 멀넣든 출력 동일!
...
class NonOver {
    ...
    // 다형성이 적용되지 않으면 생성한 메서드마다 이름을 제각각 정해야하므로
    // 개발자가 일일히 기억해서 사용해야 하는 번거로움
}
...
class Over {
    ...
    public double add(double a, double b) {
        ...
        // 다형성이 적용하면 기능은 달라도 메서드이름이 통일되므로 개발자가 메서드를 일일히 외울필요없음
