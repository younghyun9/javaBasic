...
public class EX05 {
    ...
    static class Fan {
        final int SLOW = 1;             //final 은 변하지않는다를 의미 (상수, 재정의 불가 변수)
        final int MEDIUM =2;
        final int FAST =3;
        // SLOW = 5;    //  재정의 안됨
       ...
       public Fan(int speed, boolean on, double radius, String color) {    // 정의 순서 잘지키기!
           this.speed = speed;
           this.on = on;
           this.radius = radius;
           this.color = color;
    ...
    static class Account {
        ...
        public Account() {}   // 초기값 0이라 굳이 입력하지않았다
