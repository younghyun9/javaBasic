...
public class ValueObject {
    public static void main(String[] args) {
        ...
        // 이때 stter/getter 메서드를 이용하면 접근 불가변수를 조작 할 수 있음
...
//        sj.mat = 88;
        ...
        // 멤버변수가 private으로 선언되었으므로 접근불가 -> 값 대입 실패
        // OOP에서는 객체의 변수를 외부에서 직접 접근하는것을 권장하고 있지않음
...
class C {
    ...
    //getter 정의 : public 반환유형 get변수명()    //여기서 변수명은 첫글자 대문자로
    //                 return 변수명;
...
class D {
    ...
    public D(){                    // 알트 인서트눌러서 생성자 만드는거 기억하기기
