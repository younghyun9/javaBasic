package 용현.basic.day13;

import 용현.basic.sungjuk.SungJukService;
import 용현.basic.sungjuk.SungJukServiceImpl;
import 용현.basic.sungjuk.SungJukServiceV2;
import 용현.basic.sungjuk.SungJukServiceV2Impl;

import java.util.Scanner;

public class SungJukV6Main {

    // 성적처리 프로그램 V6 - ArrayLost + CRUD
    // 동적배열을 이용해서 다수의 성적데이터를 저장할수 있게 함
