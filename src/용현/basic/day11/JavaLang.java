...
public class JavaLang {
    public static void main(String[] args) {
        ...
        // import문 없이 사용 가능
        // 대표적인 예시) Math, String, StringBuilder/StringBuffer
        ...
        // Class 클래스
        // 실행중인 자바프로그램 내부에 포함된 클래스와 인터페이스 정보를 제공
        // 또한, 동적으로 객체를 생성할수도 있음

        // Math 클래스
        // 다양한 수학적 연산을 위한 메서드 제공
        // 모든 메서드가 static이기 때문에 객체 생성없이 바로 메서드 호출가능
        // max, min, random, ceil, floor, round(반올림)
        ...
        // ex) 3.1415926dptj round메서드를 이용해서 소수점 2째자리까지 구하려면?
