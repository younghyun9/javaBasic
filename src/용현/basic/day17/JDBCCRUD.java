...
public class JDBCCRUD {
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        String amz = "bigdata.c9ckxxzrgiui.ap-northeast-2.rds.amazonaws.com";
        String url = "jdbc:mariadb://" + amz + ":3306/bigdata";
        String usr = "playground";
        String pwd = "bigdata2020";

        // JDBC 관련 sql 정의
        String books = "create table books (bookid int," + "bookname varchar(30), publish varchar(30)," +
                "price int)";
