...
public class People {
    ...
    public static void main(String[] args) {
        ...
        // 객체의 기능을 나타내는 메서드로 구성         // 실무에서는 필드/속성과      기능을 따로 많이 만듬
        ...
        // 이렇게 생성된 객체는 독립된 메모리 공간에 저장된 자신만의 변수를 가질수 있음
        ...
        Person p = new Person();               // 묶어서 선언하는게 편함
        ...
        Student s2 = new Student("20125006", "송혜교", "서울영등포구",
                                  "1988.9.17", "컴퓨터", "301");

        // 객체에 대입한 값 출력하기 (마지막 부분)
        // 객체명. 맴버변수명  << 이 형식으로
        ...
        // 고객 클래스
        static class Person{
           //변수 선언 (속성 property, 필드 field, 멤버 member) 보는관점에따라 말하는게 다름
            private  String name;
            private  String job;
            private  int age;
            ...
            //   초기화 코드
            // }
            // 생성자의 매개변수명과 멤버변수명이 일치할때 일반적으로 shadowing 현상이 발생
            //클래스의 멤버변수임을 명확하게 표한하기 위해 this 라는 키워드를 추가함
