...
public class SungJukV4b {
    ...
    //              주로 데이터 베이스를 사용해서 데이터를 추가/조회/수정/삭제하는 기능을 작성함함

   public static void main(String[] args) {
       // 성적 데이터 생성
       SungJuk sj = new SungJuk("용현", 96, 100 , 56);

       // 성적처리를 위해 service 객체 생성
       SungJukService sjsrv = new SungJukService();  //sjsrv 는 그냥 약어인가

       // 성적 처리
       sjsrv.computeSunJuk(sj);
    ...
    static class SungJukService {
        ...
        // 성적처리
        public void computeSunJuk(SungJuk sj) {
