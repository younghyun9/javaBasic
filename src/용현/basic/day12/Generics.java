...
public class Generics {
    public static void main(String[] args) {
        ...
        // 실행할때 발생할 수 있는 타입간 오류를 컴파일할때 발견할 수 있도록 해주는 기능
        // JDK 1.5에서 부터 추가된 기능
        ...
        // Object형으로 배열을 선언하면 어떤 데이터타입의 객체든지간에
        // 모두 저장 가능
        ...
        // System.out.println( Integer.parseInt(numbers1[0])+Integer.parseInt(numbers1[1]) + Integer.parseInt(numbers1[2] );
        // 오류발생 -> 비정상 형변환이 원인
        // 컴파일 할때 잘못되었다고 오류를 띄워줌
        // Object타입은 바로정수로 변환 불가라서

        // JDK1.5 이전에서는 여러 타입을 사용하는 대부분의 클래스나
        // 메서드에서 인수나 반환값으로 Object타입을 사용했었음
        // 이런경우, 반환된 Object 객체를 다시원하는 타입으로 변환해야하고
        ...
        // 컴파일할때 오류없다가 실행할때 되서야 오류가 출력됨

        // JDK1.5 에서 도입한 제너릭을 활용하면
        // 컴파일할때 타입이 정해지므로
        ...
        zoo2.add(new Lion());
        // zoo2.add(new Tiger());
        // 컴파일할때 타입체크 가능 - zoo2에는 tiger 객체를 추가못함
        ...
        // num2 라는 배열변수에는 String형의 값만 저장할 수 있음
