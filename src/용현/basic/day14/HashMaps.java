...
public class HashMaps {
    public static void main(String[] args) {
        ...
        // 주로 사용되는 해시 알고리즘은 CRC32, MD5, SHA-1 로 해시값 비교
        // fileformat.info/tool/hash.htm // 해시 검색 사이트
        ...
        names.replace("h","Hekyo");         // h를 Hekyo로 수정
        System.out.println(names.get("h"));  // 수정한 값이 나옴
    }
