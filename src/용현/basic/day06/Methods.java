...
public class Methods {
    public static void main(String[] args) {
        ...
        // C 언어의 함수와 유사
        // 중복되는 코드들의 반복적인 프로그래밍을 피할수 있음
        // 모듈화를 통해 프로그램의 이해도 증가
        // 코드의 문제발생 또는 기능변경시에 손쉽게 유지보수 가능
        ...
        for (int i = 1; i <= 10; i++) {                      // 이구문을 추가함으로써 10번 반복
            int magic = (int) (Math.random() * 10) + 1;    // 난수 1개 설정하는법
            System.out.print(magic + " ");                     // 이 두줄을 열번 반복하면 난수 10개 생성 가능
        }
        System.out.println(" ");
        ...
        for (int i = 1; i <= 10; i++) {
            make_magic();                              // 밑에 수식을 따로 뺴놔서 프로그램 이해도를 높임 (밑에 모듈화)
        ...
        // 인삿말 출력 v2b - "Hello,Java"라는 메시지출력
       sayHello2();
